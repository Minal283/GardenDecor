package com.cg.main.gardendecor.controller;
...
import com.cg.main.gardendecor.exception.GardenDecorNotFoundException;
import com.cg.main.gardendecor.model.GardenDecor;
import com.cg.main.gardendecor.service.IDecorService;
 ...
 */
	...
	public ResponseEntity<List<GardenDecor>> getAllGardenDecorName(@PathVariable String productName) {
		...
		return new ResponseEntity<>(gardendecors, HttpStatus.OK);
	}
	/**
	 * 
	 * @param productId
	...
	public ResponseEntity<Integer> addGardenDecor(@Valid @RequestBody GardenDecor gardendecor) {
		...
		return new ResponseEntity<>(gardendecorInfo.getProductId(), HttpStatus.OK);
	}
	/**
	 * 
	 * @param gardendecor
	...
	public ResponseEntity<GardenDecor> updateGardenDecor(@RequestBody GardenDecor gardendecor) {
		...
		return new ResponseEntity<>(gardendecorInfo, HttpStatus.OK);
	}
	/**
	 * 
	 * @param productId
